...
const Project = () => {
  ...
  const[cardsToShhow,setCardsToShow]=useState(1)
  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='projects'>
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Spaces, Building legacies-Expolore Our Portfolio</p>
      ...
      <div className='overflow-hidden '>
        ...
        style={{transform:`translateX(-${(currentIndex*100)/cardsToShhow}%)`}}>
